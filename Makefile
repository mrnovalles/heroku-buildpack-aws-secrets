...
.libs/heroku-buildpack-testrunner:
	...
	git clone https://github.com/mrnovalles/heroku-buildpack-testrunner .libs/heroku-buildpack-testrunner
...
test: .libs/heroku-buildpack-testrunner .libs/shunit2
	SHUNIT_HOME=$(realpath $(@D))/.libs/shunit2/ ./.libs/heroku-buildpack-testrunner/bin/run .
